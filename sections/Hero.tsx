    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 relative">
        ...
        <motion.div 
          ...
          animate="visible"
        >
          <motion.p variants={itemVariants} className="inline-block px-5 py-2 rounded-full border border-primary/30 bg-primary/10 text-primary font-medium tracking-wide uppercase mb-6 text-sm backdrop-blur-sm shadow-[0_0_20px_rgba(6,182,212,0.2)]">
            Welcome to my portfolio
          </motion.p>
          
          <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1] text-white">
            Hi, I&apos;m Ahmed Elsawaf
            <br />
            <span className="text-gradient drop-shadow-[0_0_15px_rgba(6,182,212,0.4)]">Front-End Developer</span>
          </motion.h1>
          
          <motion.p variants={itemVariants} className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light">
            I craft modern, premium, and interactive web experiences with a focus
            on performance, scalable architecture, and stunning visual design.
          </motion.p>

          <motion.div variants={itemVariants} className="flex flex-wrap gap-5 justify-center lg:justify-start items-center">
            <motion.a
          ...
          <motion.div variants={itemVariants} className="mt-12 flex items-center justify-center lg:justify-start gap-6">
            {[
              { icon: FaGithub, href: "https://github.com/a7med0mo3taz", hover: "hover:text-white hover:border-white/50 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]" },
              { icon: FaLinkedin, href: "https://linkedin.com/in/ahmed-elsawaf-9aa3642b4", hover: "hover:text-[#0077b5] hover:border-[#0077b5]/50 hover:shadow-[0_0_20px_rgba(0,119,181,0.3)]" },
              { icon: FaEnvelope, href: "mailto:elsawafahmed740@gmail.com", hover: "hover:text-primary hover:border-primary/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.3)]" }
            ].map((social, idx) => (
              <motion.a
                key={idx}
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-xs md:text-sm font-bold text-white tracking-wide">Available for work</span>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs md:text-base font-extrabold text-white leading-tight tracking-wide">React & Next.js</span>
                <span className="text-[8px] md:text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5 md:mt-1">Developer</span>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
