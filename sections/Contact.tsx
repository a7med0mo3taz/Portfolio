...
import { FaWhatsapp, FaLinkedin, FaGithub, FaDownload, FaEnvelope, FaGoogle } from "react-icons/fa";
...
export default function Contact() {
  ...
  const handleGmail = () => {
    ...
    const subject = encodeURIComponent(`New Contact from ${formData.name} - Portfolio`);
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 tracking-tight text-white text-center">
            Get In <span className="text-gradient drop-shadow-[0_0_15px_rgba(6,182,212,0.5)]">Touch</span>
          </h2>
          ...
          <p className="text-gray-400 mt-8 text-center max-w-2xl text-xl font-light leading-relaxed">
            Have an exciting project in mind or want to collaborate? Fill the form below and choose how you want to reach me.
          </p>
        </motion.div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-5 flex flex-col gap-6">
            <div className="glass p-10 rounded-[2.5rem] flex flex-col relative overflow-hidden group hover:border-primary/40 transition-all duration-700 shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-1 h-full">
              ...
              <div className="flex flex-col gap-5 flex-1">
                <a href="mailto:elsawafahmed740@gmail.com" className="flex items-center gap-4 p-4 rounded-2xl border border-white/5 bg-dark/40 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300 group/link">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold break-all">elsawafahmed740@gmail.com</p>
                  </div>
                </a>

                <a href="https://wa.me/201009234199" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-2xl border border-white/5 bg-dark/40 hover:bg-[#25D366]/10 hover:border-[#25D366]/30 transition-all duration-300 group/link">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 font-medium tracking-wide">WhatsApp</p>
                    <p className="text-white font-semibold">+201009234199</p>
                  </div>
                </a>

                <a href="/assets/Ahmed_Moataz_Ahmed_Elsawaf_CV.pdf" download className="mt-auto flex items-center justify-center gap-3 w-full py-4 rounded-2xl bg-gradient-to-r from-primary to-secondary text-white font-bold tracking-wide hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="flex items-center gap-4 mt-8 pt-8 border-t border-white/5">
                <a href="https://linkedin.com/in/ahmed-elsawaf-9aa3642b4" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="w-12 h-12 rounded-full border border-white/10 bg-white/5 flex items-center justify-center hover:bg-[#0077b5] hover:border-transparent text-gray-400 hover:text-white transition-all duration-300">
                  <FaLinkedin className="text-xl" />
                </a>
                <a href="https://github.com/a7med0mo3taz" target="_blank" rel="noreferrer" aria-label="GitHub" className="w-12 h-12 rounded-full border border-white/10 bg-white/5 flex items-center justify-center hover:bg-white hover:border-transparent text-gray-400 hover:text-dark transition-all duration-300">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-7">
            <div className="glass p-10 md:p-14 rounded-[2.5rem] flex flex-col relative overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.3)] border border-white/10 h-full">
              ...
              <div className="mt-auto pt-6 border-t border-white/5">
                <p className="text-sm text-gray-400 font-medium mb-4 ml-1">Choose how to send:</p>
